...
To render vignette: 
  devtools::build_rmd("vignettes/use_HMNM_local.Rmd")
  devtools::build_rmd("vignettes/use_HMNM.Rmd")

Alternative::
To render Vignette:
  1) Duplicate vignette file and add '.orig' extension 
  2) Run this code to locally knit the vignette.
  source("/Users/samboyd/Documents/HMNM/R package/HMNM/vignettes/makeVignette-use_HMNM.R")
...
2. Prepare data inputs. 
    ...
    d. Choose another set of continuous values to be used in a biased random walk (__brw_attr__ arg). (Optional)
...
#>    0.0002815760    0.0001396638    0.0001497703    0.0001075183    0.0002979059    0.0001413620
head(sort(rwr_scores, decreasing = TRUE))
#> ENSP00000478725 ENSP00000497642 ENSP00000291582 ENSP00000349116 ENSP00000355180 ENSP00000231487 
#>    0.0012518738    0.0009628979    0.0009246253    0.0008856055    0.0008457441    0.0008305532
```
...
#> + edges from 06f6550 (vertex names):
#>  [1] ENSP00000366557|layer1->ENSP00000419270|layer1 ENSP00000362361|layer1->ENSP00000357748|layer1 ENSP00000362361|layer1->ENSP00000478121|layer1
#>  [4] ENSP00000362361|layer1->ENSP00000363193|layer1 ENSP00000347168|layer1->ENSP00000355780|layer1 ENSP00000347168|layer1->ENSP00000262367|layer1
#>  [7] ENSP00000347168|layer1->ENSP00000440542|layer1 ENSP00000347168|layer1->ENSP00000319169|layer1 ENSP00000347168|layer1->ENSP00000308405|layer1
#> [10] ENSP00000494750|layer1->ENSP00000258198|layer1 ENSP00000494750|layer1->ENSP00000387393|layer1 ENSP00000494750|layer1->ENSP00000304669|layer1
#> [13] ENSP00000494750|layer1->ENSP00000349679|layer1 ENSP00000494750|layer1->ENSP00000411932|layer1 ENSP00000355780|layer1->ENSP00000440542|layer1
#> [16] ENSP00000383402|layer1->ENSP00000412324|layer1 ENSP00000434466|layer1->ENSP00000339495|layer1 ENSP00000258198|layer1->ENSP00000349679|layer1
#> [19] ENSP00000477527|layer1->ENSP00000494750|layer1 ENSP00000477527|layer1->ENSP00000367034|layer1 ENSP00000331310|layer1->ENSP00000387393|layer1
#> [22] ENSP00000331310|layer1->ENSP00000369131|layer1 ENSP00000309116|layer1->ENSP00000215832|layer1 ENSP00000215832|layer1->ENSP00000309116|layer1
...
#> 1               0.90         0.565            0.701                  0.805       2658      11480   0.002          0.513                   0.598  0.14
#> 2               0.90         0.936            1.207                  0.775       1311       3868   0.002          0.446                   0.507  0.14
#> 3               0.95         1.231            1.603                  0.768        684       1556   0.003          0.384                   0.478  0.15
#> 4               0.95         1.513            1.918                  0.789        363        712   0.005          0.331                   0.469  0.15
#> 5               0.95         1.692            2.104                  0.804        258        450   0.007          0.282                   0.289  0.16
#> 6               0.90         1.777            2.200                  0.808        177        285   0.009          0.235                   0.314  0.18
#> 7               0.95         1.899            2.359                  0.805        139        209   0.011          0.197                   0.215  0.18
#> 8               0.95         1.861            2.399                  0.776        128        181   0.011          0.161                   0.079  0.20
#> 9               0.90         1.974            2.470                  0.799        107        143   0.013          0.132                   0.164  0.20
#> 10              0.95         2.050            2.480                  0.827         79        106   0.017          0.111                   0.262  0.17
#> 11              0.75         2.044            2.436                  0.839         63         81   0.021          0.094                   0.203  0.17
#> 12              0.50         1.949            2.408                  0.809         60         75   0.021          0.072                   0.048  0.26
#> 13              0.45         1.958            2.399                  0.816         59         73   0.021          0.048                   0.017  0.41
#> 14              0.45         1.959            2.390                  0.819         57         70   0.022          0.034                   0.034  0.33
```
...
# Only keep relevant bipartite edges [bottleneck]
bp_el <- bp_el[apply(bp_el, 1, function(x) all(x[1:2] %in% c(ppi_names, mmi_names))),]
...
#> [4,] "CIDm00000006" "ENSP00000263341" "0.7"
#> [5,] "CIDm00000006" "ENSP00000306512" "0.7"
#> [6,] "CIDm00000007" "ENSP00000335153" "0.8"
...
class(net$network)
net$network
#> PH b6e560a UNW- 31935 208693 -- 
#> + attr: name (v/c), original_name (v/c), layer (v/c), data (v/n), brw_attr (v/n), seeds (v/n), Z (v/n), weight (e/n)
#> + edges from b6e560a (vertex names):
#>  [1] CIDm00000085|metadat--CIDm00000181|metadat CIDm00000085|metadat--CIDm00000317|metadat CIDm00000085|metadat--CIDm00000380|metadat
#>  [4] CIDm00000085|metadat--CIDm00000783|metadat CIDm00000085|metadat--CIDm00000784|metadat CIDm00000085|metadat--CIDm00000925|metadat
#>  [7] CIDm00000085|metadat--CIDm00000928|metadat CIDm00000085|metadat--CIDm00000961|metadat CIDm00000085|metadat--CIDm00000977|metadat
#> [10] CIDm00000085|metadat--CIDm00001033|metadat CIDm00000085|metadat--CIDm00441252|metadat CIDm00000085|metadat--CIDm03082227|metadat
#> [13] CIDm00000085|metadat--CIDm25271602|metadat CIDm00000085|metadat--CIDm52922022|metadat CIDm00000085|metadat--CIDm00000224|metadat
#> [16] CIDm00000085|metadat--CIDm00000238|metadat CIDm00000085|metadat--CIDm00001023|metadat CIDm00000085|metadat--CIDm00000197|metadat
#> [19] CIDm00000085|metadat--CIDm00000222|metadat CIDm00000085|metadat--CIDm00000280|metadat CIDm00000085|metadat--CIDm00001003|metadat
#> [22] CIDm00000085|metadat--CIDm00023925|metadat CIDm00000085|metadat--CIDm00000051|metadat CIDm00000085|metadat--CIDm00001110|metadat
#> + ... omitted several edges
table(V(net$network)$layer)
#> 
#>   metadat  metadat2 phosphdat   protdat  protdat2 
#>     11748     11748      2813      2813      2813
...
crosstalk_params <- c(protdat = 0.2, phosphdat = 0.2, meta = 0.7)
```
...
```{r ml6}
# Determine which sets of categories in your network hierarchy should be given seed weights
...
# Time
print(igraph::vcount(net$network)) # 31935
print(mod$time) # 4.72 mins

# Active module
mod$module
#> W- 58 93 -- 
#> + attr: name (v/c), original_name (v/c), layer (v/c), data (v/n), brw_attr (v/n), seeds (v/n), Z (v/n), agg_layer (v/c), weight (e/n)
#> + edges from 96ed34f (vertex names):
#>  [1] CIDm00000783|metadat--CIDm00000961|metadat CIDm00000783|metadat--CIDm00000101|metadat CIDm00000961|metadat--CIDm00000101|metadat
#>  [4] CIDm00000783|metadat--CIDm00134924|metadat CIDm00000961|metadat--CIDm00134924|metadat CIDm00000783|metadat--CIDm00439479|metadat
#>  [7] CIDm00000961|metadat--CIDm00439479|metadat CIDm00000961|metadat--CIDm00188350|metadat CIDm00000783|metadat--CIDm00001106|metadat
#> [10] CIDm00000961|metadat--CIDm00001106|metadat CIDm00000783|metadat--CIDm23724717|metadat CIDm00000961|metadat--CIDm23724717|metadat
#> [13] CIDm00000783|metadat--CIDm00000507|metadat CIDm00000961|metadat--CIDm00000507|metadat CIDm00000783|metadat--CIDm00008947|metadat
#> [16] CIDm00000961|metadat--CIDm00008947|metadat CIDm00000783|metadat--CIDm09904478|metadat CIDm00000961|metadat--CIDm09904478|metadat
#> [19] CIDm00000783|metadat--CIDm25200719|metadat CIDm00000961|metadat--CIDm25200719|metadat CIDm00000783|metadat--CIDm00656475|metadat
#> [22] CIDm00000783|metadat--CIDm24892736|metadat CIDm00000783|metadat--CIDm00001013|metadat CIDm00000961|metadat--CIDm00001013|metadat
#> + ... omitted several edges
table(V(mod$module)$layer)
#> 
#>   metadat  metadat2 phosphdat 
#>        24        33         1

# Access original names supplied by user
head(V(mod$module)$original_name)
#> [1] "CIDm00000783" "CIDm00000961" "CIDm00000101" "CIDm00134924" "CIDm00439479" "CIDm00188350"
```
...
#> [1] "CIDm00000783|metadat" "CIDm00000961|metadat" "CIDm00000197|metadat" "CIDm00001003|metadat" "CIDm09955837|metadat" "CIDm00000033|metadat"
...
# When was protein ENSP00000383392 removed?
protein <- "ENSP00000383392"
...
#> [1] HMNM_1.0.0   dplyr_1.1.4  igraph_2.0.3
#> 
#> loaded via a namespace (and not attached):
#>  [1] utf8_1.2.4        generics_0.1.3    lattice_0.22-6    digest_0.6.37     magrittr_2.0.3    evaluate_1.0.0    grid_4.4.1        iterators_1.0.14  pkgload_1.4.0    
#> [10] fastmap_1.2.0     rprojroot_2.0.4   R.oo_1.26.0       foreach_1.5.2     doParallel_1.0.17 Matrix_1.7-0      R.utils_2.12.3    sessioninfo_1.2.2 pkgbuild_1.4.5   
#> [19] brio_1.1.5        urlchecker_1.0.1  promises_1.3.2    purrr_1.0.2       fansi_1.0.6       codetools_0.2-20  cli_3.6.3         shiny_1.9.1       rlang_1.1.4      
#> [28] R.methodsS3_1.8.2 ellipsis_0.3.2    remotes_2.5.0     withr_3.0.1       cachem_1.1.0      yaml_2.3.10       devtools_2.4.5    tools_4.4.1       parallel_4.4.1   
#> [37] memoise_2.0.1     httpuv_1.6.15     vctrs_0.6.5       R6_2.5.1          mime_0.12         lifecycle_1.0.4   htmlwidgets_1.6.4 fs_1.6.4          usethis_3.1.0    
#> [46] miniUI_0.1.1.1    desc_1.4.3        pkgconfig_2.0.3   pillar_1.9.0      later_1.4.1       data.table_1.16.0 glue_1.7.0        profvis_0.4.0     Rcpp_1.0.13      
#> [55] xfun_0.49         tibble_3.2.1      tidyselect_1.2.1  rstudioapi_0.17.1 knitr_1.49        xtable_1.8-4      htmltools_0.5.8.1 rmarkdown_2.29    testthat_3.2.1.1 
#> [64] compiler_4.4.1
```
